...
struct system_state {
    ...
    float current_pressure;         /*!< Latest pressure reading (bar) */
    ...
    /* Data stream: when true, sensor_read_task sends "D <flow> <temp> <pressure>" at 10Hz */
    bool stream_enabled;
